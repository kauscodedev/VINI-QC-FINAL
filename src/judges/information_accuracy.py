"""Information Accuracy Judge — flags factual contradictions with tool results / context."""
...
SYSTEM_PROMPT = load_prompt("judge_information_accuracy")


async def judge_information_accuracy(
    ctx: ContextJSON,
    ...
    logger.info(f"information_accuracy: score={result.score} na={result.score_na} issues={len(result.issues)}")
    return result
