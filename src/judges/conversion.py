"""Lead Qualification & Conversion Judge — appointment booking, hard time slots, objection handling."""
...
SYSTEM_PROMPT = load_prompt("judge_conversion")


async def judge_conversion(
    ctx: ContextJSON,
    ...
    logger.info(f"conversion: score={result.score} na={result.score_na} issues={len(result.issues)}")
    return result
