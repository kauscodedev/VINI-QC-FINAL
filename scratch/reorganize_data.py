...
source_dir = "individual_calls/New Calls"
processed_dir = "data/Processed_calls"
unprocessed_dir = "data/unprocessed_calls"
...
for filename in files:
    ...
    if call_id in scored_ids:
        ...
        # Move to unprocessed
        shutil.move(src_path, os.path.join(unprocessed_dir, filename))
        moved_unprocessed += 1

print(f"Moved {moved_processed} calls to {processed_dir}")
print(f"Moved {moved_unprocessed} calls to {unprocessed_dir}")
